...
class SUBTests: XCTestCase {
  ...
  func test8BitSub() {
    ...
    XCTAssertEqual(ctx.registers.A, UInt8(0x2), "could not substract two registers")
    XCTAssert(ctx.registers.Flags.isFlagSet(Flags.Subtract), "Subtract Flag was not set after SUB")
